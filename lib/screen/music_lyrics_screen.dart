...
import 'package:music_application/blocs/connectivity_bloc.dart';
import 'package:music_application/blocs/music_detail_bloc.dart';
import 'package:music_application/blocs/music_lyrics_bloc.dart';
...
import 'package:music_application/models/music_list.dart' as ListTrack;
                  ...
                  switch (snapshot.data!.status) {
                    ...
                    case Status.COMPLETED:
                      return InfoTile(
                        heading: 'Lyrics',
                        body: snapshot
                                .data!.data!.message.body.lyrics.lyricsBody ??
                            "",
                      );
                      break;
                    case Status.ERROR:
